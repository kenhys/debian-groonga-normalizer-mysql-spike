...
case $1 in
    cleanup)
	sudo apt-get purge -y libgroonga0 groonga-doc groonga-server-common groonga-httpd groonga-normalizer-mysql
	...
	;;
    purge)
	sudo apt-get purge -y libgroonga0 groonga-doc groonga-server-common groonga-httpd groonga-bin groonga-munin-plugins groonga-normalizer-mysql
	check
	;;
    remove)
	sudo apt-get remove -y libgroonga0 groonga-doc groonga-server-common groonga-httpd groonga-normalizer-mysql
	check
	;;
    install)
	sudo apt-get clean
	sudo apt-get update
	sudo apt-get install -V -y groonga-normalizer-mysql
	check
	;;
    pdo)
